    ...
    value: function(require, exports, module) {
        ...
        function HistoryRuntime() {
            ...
            function reset() {
                undoDiffs = [];
                redoDiffs = [];
                lastSnap = minder.exportJsondata();
            }
            function makeUndoDiff() {
                var headSnap = minder.exportJsondata();
            ...
            function makeRedoDiff() {
                var revertSnap = minder.exportJsondata();
				...
				if (typeof(seajs) != 'undefined') {
					...
					define('demo', function(require) {
						...
						editor.minder.on('contentchange', function() {
							window.localStorage.__dev_minder_content = JSON.stringify(editor.minder.exportJsondata());
						});
